...
export type AssessmentFormProps = {
  ...
  compact?: boolean;
  /** Subtle spacing refinements for the dedicated consultation request form. */
...
export function AssessmentForm({
  ...
  const compactInputClass = consultation
    ? "h-12 min-h-[48px] max-h-[52px] px-3.5 text-sm leading-tight"
