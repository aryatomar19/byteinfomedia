...
export function TechSolutionsPage() {
  ...
  return (
    <>
      <section className="tech-solutions-hero relative min-h-[72vh] overflow-hidden bg-[#050f23] lg:min-h-[78vh]">
        <div className="tech-solutions-hero__bg" aria-hidden>
          <img src={hero.image} alt="" />
        </div>
        <div className="absolute inset-0 tech-solutions-hero__overlay" aria-hidden />
        <div className="absolute inset-0 tech-solutions-hero__glow" aria-hidden />
