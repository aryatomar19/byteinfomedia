    ...
    <>
      ...
      <section className="section-enterprise bg-white">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <Reveal delay={0.1}>
            <div className="mt-8 overflow-hidden rounded-2xl border border-[#FF6B2C]/20 bg-gradient-to-r from-[#0A0F1C] via-[#151d30] to-[#0A0F1C] px-6 py-5 text-center shadow-[0_20px_56px_rgba(10,15,28,0.12)] sm:px-8 sm:py-6">
              <p className="flex flex-col items-center justify-center gap-2 text-base font-bold text-white sm:flex-row sm:gap-4 sm:text-lg">
                <span>{whyChoose.highlight.experience}</span>
                <span className="hidden text-[#FF6B2C] sm:inline" aria-hidden>
                  |
                </span>
                <span className="text-[#ffb088] sm:hidden" aria-hidden>
                  |
                </span>
                <span>{whyChoose.highlight.projects}</span>
              </p>
            </div>
          </Reveal>
        </div>
