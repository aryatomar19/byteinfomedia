    ...
    <section id="assessment" className="section-surface py-14 sm:py-16">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <Reveal className="mb-8">
          ...
          <h2 className="mt-3 font-[family-name:var(--font-inter)] text-2xl font-extrabold tracking-tight text-[#0A0F1C] sm:text-3xl">
            Let&apos;s Discuss Your Cloud Journey
          </h2>
          <p className="mt-3 max-w-2xl text-sm leading-7 text-[#0A0F1C]">
            Connect with our consultants for AWS, DevOps, security, managed services, or AI engagements.
          </p>
        </Reveal>

        <div className="overflow-hidden rounded-[1.75rem] border border-[#0A0F1C]/8 bg-white shadow-[0_24px_64px_rgba(10,15,28,0.08)]">
