    ...
    >
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <Reveal className="section-heading mx-auto max-w-2xl text-center">
          ...
          >
            {growYourBusinessSection.title}
          </h2>
          <p className="mt-3 text-base leading-7 text-[#334155]">{growYourBusinessSection.description}</p>
        </Reveal>

        <RevealStagger className="section-cards grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
          {growYourBusinessSection.offerings.map((item) => (
