        ...
        <div className="mt-10 grid gap-6 sm:mt-12 lg:grid-cols-2 lg:gap-8">
          {homeServiceCategories.map((category, index) => (
            <motion.article
              ...
              whileHover={{ y: -6 }}
              className="enterprise-card group overflow-hidden rounded-[1.75rem]"
            >
              <Link href={category.href} scroll className="block">
                <div className="relative aspect-[16/9] overflow-hidden sm:aspect-[21/9]">
                  ...
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-[#07162d]/85 via-[#07162d]/35 to-[#07162d]/10" />
