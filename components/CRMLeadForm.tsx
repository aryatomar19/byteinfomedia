  ...
  return (
    ...
    >
      ...
      <div className={`relative grid gap-4 ${compact ? "" : "sm:grid-cols-2"}`}>
        <label className="grid gap-2 text-xs font-bold uppercase tracking-[0.14em] text-slate-400" htmlFor={`${intent}-name`}>
          ...
          <input
            ...
            autoComplete="name"
            className="rounded-2xl border border-white/10 bg-white/[0.065] px-4 py-3.5 text-sm font-medium normal-case tracking-normal text-white outline-none transition placeholder:text-slate-500 hover:border-white/20 focus:border-orange-300/80 focus:bg-white/[0.1] focus:shadow-[0_0_0_4px_rgba(255,107,44,0.10)]"
          />
        </label>
          ...
          <>
            ...
            <label className="grid gap-2 text-xs font-bold uppercase tracking-[0.14em] text-slate-400" htmlFor={`${intent}-service`}>
              ...
              <select
                id={`${intent}-service`}
                name="service"
                className="rounded-2xl border border-white/10 bg-slate-950 px-4 py-3.5 text-sm font-medium normal-case tracking-normal text-white outline-none transition hover:border-white/20 focus:border-orange-300/80 focus:shadow-[0_0_0_4px_rgba(255,107,44,0.10)]"
                defaultValue=""
              >
      ...
      <button
        ...
        className="group relative mt-5 inline-flex w-full items-center justify-center gap-2 overflow-hidden rounded-2xl bg-gradient-to-r from-orange-300 via-white to-orange-100 px-5 py-4 text-sm font-black uppercase tracking-[0.12em] text-slate-950 shadow-[0_24px_70px_rgba(255,107,44,0.30)] transition hover:-translate-y-1 hover:shadow-[0_30px_90px_rgba(255,107,44,0.36)] disabled:cursor-not-allowed disabled:opacity-70"
      >
