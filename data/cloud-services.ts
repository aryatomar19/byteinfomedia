...
export const cloudImages = {
  ...
  kubernetes: "/images/cloud/Kubernetes.png",
  ...
  capabilities: [
    {
      title: "Private Cloud",
      description:
        "Secure and scalable private cloud environments with encryption, isolation, and compliance controls built for performance, control, and enterprise security.",
