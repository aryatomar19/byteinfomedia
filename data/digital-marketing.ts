    ...
    steps: [
      {
        ...
        items: ["SEO Audit", "Competitor Analysis", "Market Research"],
      },
      {
        step: "STEP 2",
        title: "Strategy Planning",
        items: ["Channel Selection", "Campaign Planning", "KPI Definition"],
      },
      {
        step: "STEP 3",
        title: "Creative & Development",
        items: ["Content Creation", "Ad Creatives", "Landing Pages", "Website Optimization"],
      },
      {
        step: "STEP 4",
        title: "Campaign Launch",
        items: ["Google Ads", "Meta Ads", "SEO Execution", "Social Media Marketing"],
      },
      {
        step: "STEP 5",
        title: "Performance Tracking",
        items: ["Analytics", "Reporting", "Conversion Tracking"],
      },
      {
        step: "STEP 6",
        title: "Scale & Growth",
        items: ["Optimization", "Retargeting", "Revenue Growth"],
      },
    ],
  },
  results: {
